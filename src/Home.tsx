      ...
      <nav className="fixed top-0 w-full z-50 border-b bg-background/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-[0.2em]">
            <a href="#projects" className="hover:text-accent transition-colors cursor-pointer">Projects</a>
            <a href="#experience" className="hover:text-accent transition-colors cursor-pointer">Experience</a>
            <a href="#writing" className="hover:text-accent transition-colors cursor-pointer">Writing</a>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
                <div className="max-w-xl">
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap gap-4">
                    <a href="#projects" className="w-full sm:w-auto cursor-pointer">
                      <Button className="w-full sm:w-auto bg-primary hover:bg-foreground hover:text-background text-primary-foreground rounded-none h-14 px-10 text-sm font-bold uppercase tracking-widest transition-all duration-300 cursor-pointer">
                        Explore Projects
                      </Button>
                    </a>
                    <div className="flex items-center justify-center sm:justify-start gap-6 px-6 h-14 border border-foreground/20 w-full sm:w-auto">
                      <a href="https://www.linkedin.com/in/jacobhull" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors flex items-center gap-2 text-xs font-bold uppercase tracking-widest cursor-pointer">
                ...
                if (isInternal) {
                  return (
                    <MotionLink
                      ...
                      to={writing.link}
                      whileHover={{ y: -10 }}
                      className="relative p-8 border-2 border-primary/5 hover:border-primary transition-all group flex flex-col h-full bg-background shadow-sm cursor-pointer overflow-hidden"
                    >
                      {cardContent}
                    </MotionLink>
                  );
              ...
              <Card className="rounded-none border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl shadow-black/50">
                ...
                >
                  ...
                  <Button 
                    ...
                    className="w-full rounded-none bg-primary hover:bg-primary/90 text-primary-foreground h-14 font-bold uppercase tracking-widest text-xs cursor-pointer"
                  >
